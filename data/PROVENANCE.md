...
| `eval_adversarial.jsonl` | 49 | Human, in `scripts/generate_adversarial_eval.py` | Synthetic paraphrases, granted-tool misuse, pagination/bulk walks, and approve-without-ACK cases aimed at keyword misses. |
