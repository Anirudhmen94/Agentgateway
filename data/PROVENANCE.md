...
| `eval_adversarial.jsonl` | 35 | Human, in `scripts/generate_adversarial_eval.py` | Synthetic paraphrases, pagination/bulk walks, and approve-without-ACK cases aimed at keyword misses. |
