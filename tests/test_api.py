...
def test_health_and_check_benign_and_scope_creep():
    clear_revocations()
    ...
    revoked = client.post("/v1/revoke", json={"agent_id": "support-triage"})
    ...
    client.post("/v1/unrevoke", json={"agent_id": "support-triage"})
    clear_revocations()
